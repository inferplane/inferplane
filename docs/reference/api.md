...
Completions, Responses, and native Bedrock ingresses and an admin plane (health, metrics, key management). Full endpoint
...
| Responses ingress | `internal/server/responsesapi/` | `POST /v1/responses`; native Responses and supported stateless text/tool adapters, with shared admission and routing controls (ADR-044/047) |
