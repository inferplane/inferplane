...
| 2 | Durable identity **shipped** (0b-1/0b-2) and mayu-plane duty-separation roles **shipped** (0b-3: six fixed roles, capability middleware, audited 403s); remaining: control-plane role gating + mutation audit (0b-4) | strategy Phase 0b (P0) | Identity + RBAC now match both competitors' enterprise tiers on the data-plane console — LiteLLM charges ~$30k/yr for this |
