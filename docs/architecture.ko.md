...
translation_source_sha256: 30b5513cc55ef3ac00ab9d29817dc91467dba0beab289c625fdc112e6d0419db
---
...
## mayu 구성도 {#mayu-component-diagram}

![코딩 에이전트의 요청은 mayu를 거쳐 공급자로 전달됩니다. inferplaned는 정책과 권한을 배포하고 공유 모드에서는 Postgres 동기 승인을 사용합니다.](assets/architecture.svg)

공유 DB 연결은 ADR-046입니다. ADR-045는 추론 때 비공개 저널에서 예약하고 새 권한을 비동기로 받습니다. 로컬 기본 모드에는 공유 승인이나 필수 CP 의존성이 없습니다.
