...
// CanonicalToAnthropicRequest serializes the already validated portable canonical view.
...
func CanonicalToAnthropicRequest(request *schema.ChatRequest) ([]byte, error) {
	copy := *request
